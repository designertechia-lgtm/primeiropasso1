...
## 1. Acesso (a primeira coisa a resolver)
...
## 2. Estrutura da página (Tabs, padrão já adotado)
...
## 4. Sugestões fortes (não pediu mas vai salvar)
...
## 6. Fatias entregáveis

**Fatia 1 — Fundação de acesso**
...
- Tabela feedback, botão flutuante de coleta
- Tab Acesso (gestão de super_admins)
- Audit log, banner global, feature flags
